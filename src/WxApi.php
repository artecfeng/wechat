<?php
    ...
    namespace artecfeng\wechat;

    /********************************************************
     * @test
     *    $options = [
     * 'appid'     => 'wxa9204975c',
     * 'appsecret' => '1834d534a39'
     * ];
     * WxApi::getInstance()->init( $options );
     * if (!isset( $_GET['code'] )) {
     ...
     * $CODE = $_GET['code'];
     *
     * $Info = WxApi::getInstance()->getUserInfo( $CODE );
     * }
     ********************************************************/
    /********************************************************
     * @author  tengju
    ...
    class WxApi {
        ...
        public function getUserInfo ($code, $appId = null, $appSecret = null) {
            $appId = is_null( $appId ) ? self::$appId : $appId;
            $appSecret = is_null( $appSecret ) ? self::$appSecret : $appSecret;
